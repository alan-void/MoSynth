...
- [Learned Motion Matching (parked experiment)](learned-motion-matching.md) - A self-contained neural reimplementation that is not part of the live pipeline, kept for reference — what it does and why it will not run as committed.
