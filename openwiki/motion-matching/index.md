...
- [Learned motion matching](learned-motion-matching.md) - What the repository provides toward replacing the database search with learned networks, and the parked Barracuda experiment that was removed to make room for it.
