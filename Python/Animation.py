...
class PoseSet:
    ...
    :param local_pos: (n_frames, n_bones, 3) parent-local joint positions
    :param local_quats: (n_frames, n_bones, 4) parent-local joint rotations, xyzw
    :param foot_contacts: (n_frames, 2) left/right foot contact flags
    :param local_vel: (n_frames, n_bones, 3) linear velocities, m/s
